...
import ch.uzh.ifi.accesscomplete.data.*
import ch.uzh.ifi.accesscomplete.data.osm.changes.StringMapChanges
import ch.uzh.ifi.accesscomplete.data.osm.osmquest.OsmQuestTable.Columns.CHANGES_SOURCE
import ch.uzh.ifi.accesscomplete.data.osm.osmquest.OsmQuestTable.Columns.ELEMENT_ID
import ch.uzh.ifi.accesscomplete.data.osm.osmquest.OsmQuestTable.Columns.ELEMENT_TYPE
import ch.uzh.ifi.accesscomplete.data.osm.osmquest.OsmQuestTable.Columns.LAST_UPDATE
import ch.uzh.ifi.accesscomplete.data.osm.osmquest.OsmQuestTable.Columns.QUEST_ID
import ch.uzh.ifi.accesscomplete.data.osm.osmquest.OsmQuestTable.Columns.QUEST_STATUS
import ch.uzh.ifi.accesscomplete.data.osm.osmquest.OsmQuestTable.Columns.QUEST_TYPE
import ch.uzh.ifi.accesscomplete.data.osm.osmquest.OsmQuestTable.Columns.TAG_CHANGES
import ch.uzh.ifi.accesscomplete.data.osm.osmquest.OsmQuestTable.NAME
import ch.uzh.ifi.accesscomplete.data.osm.osmquest.OsmQuestTable.NAME_MERGED_VIEW
