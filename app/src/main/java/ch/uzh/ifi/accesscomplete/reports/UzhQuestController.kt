...
/*
    ...
    fun answer(quest: UzhQuest2, changes: StringMapChanges, source: String) {
        /*
        val status = quest.status
    ...
    fun cleanUp(): Int {
        ...
        deleted += dao.deleteAll(
            statusIn = kotlin.collections.listOf(
                ch.uzh.ifi.accesscomplete.data.quest.QuestStatus.NEW,
                ch.uzh.ifi.accesscomplete.data.quest.QuestStatus.HIDDEN
            ),
    ...
    fun get(id: Long): UzhQuest2? = null
/*
