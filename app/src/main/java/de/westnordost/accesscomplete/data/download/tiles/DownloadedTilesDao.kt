...
import de.westnordost.accesscomplete.data.download.tiles.DownloadedTilesTable.Columns.DATE
import de.westnordost.accesscomplete.data.download.tiles.DownloadedTilesTable.Columns.TYPE
import de.westnordost.accesscomplete.data.download.tiles.DownloadedTilesTable.Columns.X
import de.westnordost.accesscomplete.data.download.tiles.DownloadedTilesTable.Columns.Y
import de.westnordost.accesscomplete.data.download.tiles.DownloadedTilesTable.NAME
import de.westnordost.accesscomplete.ktx.query
import de.westnordost.accesscomplete.util.Tile
import de.westnordost.accesscomplete.util.TilesRect
