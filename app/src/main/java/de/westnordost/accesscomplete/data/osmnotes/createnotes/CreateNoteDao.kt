package de.westnordost.accesscomplete.data.osmnotes.createnotes
...
import de.westnordost.accesscomplete.data.WhereSelectionBuilder
import de.westnordost.osmapi.map.data.BoundingBox
import de.westnordost.osmapi.map.data.Element
import de.westnordost.osmapi.map.data.LatLon
import de.westnordost.osmapi.map.data.OsmLatLon
import de.westnordost.accesscomplete.data.ObjectRelationalMapping
import de.westnordost.accesscomplete.data.osm.mapdata.ElementKey
import de.westnordost.accesscomplete.data.osmnotes.createnotes.CreateNoteTable.Columns.ELEMENT_ID
import de.westnordost.accesscomplete.data.osmnotes.createnotes.CreateNoteTable.Columns.ELEMENT_TYPE
import de.westnordost.accesscomplete.data.osmnotes.createnotes.CreateNoteTable.Columns.ID
import de.westnordost.accesscomplete.data.osmnotes.createnotes.CreateNoteTable.Columns.IMAGE_PATHS
import de.westnordost.accesscomplete.data.osmnotes.createnotes.CreateNoteTable.Columns.LATITUDE
import de.westnordost.accesscomplete.data.osmnotes.createnotes.CreateNoteTable.Columns.LONGITUDE
import de.westnordost.accesscomplete.data.osmnotes.createnotes.CreateNoteTable.Columns.QUEST_TITLE
import de.westnordost.accesscomplete.data.osmnotes.createnotes.CreateNoteTable.Columns.TEXT
import de.westnordost.accesscomplete.data.osmnotes.createnotes.CreateNoteTable.NAME
import de.westnordost.accesscomplete.ktx.*
