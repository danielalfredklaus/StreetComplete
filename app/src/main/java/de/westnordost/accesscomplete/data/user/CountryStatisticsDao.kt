package de.westnordost.accesscomplete.data.user

import android.database.sqlite.SQLiteDatabase.CONFLICT_IGNORE
import android.database.sqlite.SQLiteOpenHelper
import androidx.core.content.contentValuesOf
import de.westnordost.accesscomplete.data.user.CountryStatisticsTable.Columns.COUNTRY_CODE
import de.westnordost.accesscomplete.data.user.CountryStatisticsTable.Columns.RANK
import de.westnordost.accesscomplete.data.user.CountryStatisticsTable.Columns.SUCCEEDED
import de.westnordost.accesscomplete.data.user.CountryStatisticsTable.NAME
